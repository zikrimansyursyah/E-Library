    ...
    <header class="">
        <nav class="fixed-top d-flex align-items-center justify-content-between px-5">
            ...
            <div class="menu fs-5 fw-light d-flex gap-3">
                ...
                <a href="./book.html" class="menu-list px-3 py-1">Book</a>
...
<!-- Home, 
    Member(Tampil Daftar Anggota, Tambah Data Anggota, Ubah Data Anggota, Hapus Data Anggota), 
    Book(Tampil Data, Tambah Data, Ubah Data, Hapus Data), 
    Transaction(Pinjam Buku, Pengembalan Buku) -->